 ...
 */
import { ContractDecoder, ContractInstanceDecoder, ProjectDecoder } from "./decoders";
export { ContractDecoder, ContractInstanceDecoder, ProjectDecoder };
export { ContractBeingDecodedHasNoNodeError, ContractNotFoundError, ContractAllocationFailedError, InvalidAddressError, VariableNotFoundError, NoProviderError } from "./errors";
export type { ContractState, StateVariable, DecodedLog, EventOptions, ReturnOptions, DecodeLogOptions, ExtrasAllowed, Transaction, Log } from "./types";
...
declare type ProjectInfo = Compilations.ProjectInfo;
export { ProjectInfo };
/**
 ...
 */
export declare function forProject(settings: DecoderSettings): Promise<ProjectDecoder>;
/**
 * **This function is asynchronous.**
 *
 ...
 * @category Provider-based Constructor
 */
export declare function forArtifact(artifact: Artifact, settings: DecoderSettings): Promise<ContractDecoder>;
/**
 * **This function is asynchronous.**
 *
 ...
 */
export declare function forContract(contract: ContractConstructorObject, settings?: DecoderSettings): Promise<ContractDecoder>;
/**
 * **This function is asynchronous.**
 *
 ...
 * @category Provider-based Constructor
 */
export declare function forDeployedArtifact(artifact: Artifact, settings: DecoderSettings): Promise<ContractInstanceDecoder>;
/**
 * **This function is asynchronous.**
 *
 * Constructs a contract instance decoder for a deployed contract instance.
 ...
 * @category Truffle Contract-based Constructor
 */
export declare function forDeployedContract(contract: ContractConstructorObject, settings?: DecoderSettings): Promise<ContractInstanceDecoder>;
/**
 * **This function is asynchronous.**
 *
 ...
 * @category Provider-based Constructor
 */
export declare function forArtifactAt(artifact: Artifact, address: string, settings: DecoderSettings): Promise<ContractInstanceDecoder>;
/**
 * **This function is asynchronous.**
 *
 * Constructs a contract instance decoder for a contract instance at a given address.
 ...
 * @category Truffle Contract-based Constructor
 */
export declare function forContractAt(contract: ContractConstructorObject, address: string, settings?: DecoderSettings): Promise<ContractInstanceDecoder>;
/**
 * **This function is asynchronous.**
 *
 ...
 * @category Truffle Contract-based Constructor
 */
export declare function forContractInstance(contract: ContractInstanceObject, settings?: DecoderSettings): Promise<ContractInstanceDecoder>;
/**
 * **This function is asynchronous.**
 *
 ...
 * @category Provider-based Constructor
 */
export declare function forAddress(address: string, settings?: DecoderSettings): Promise<ContractInstanceDecoder>;
