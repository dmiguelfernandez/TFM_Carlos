 ...
 */
import { ProjectEncoder, ContractEncoder, ContractInstanceEncoder } from "./encoders";
export { ProjectEncoder, ContractEncoder, ContractInstanceEncoder };
import type { EncoderSettings, EnsSettings, EncoderInfoInternal, TxAndAbi } from "./types";
export { EncoderSettings, EnsSettings, TxAndAbi, EncoderInfoInternal };
export type { ResolveOptions } from "./types";
import type { ContractInstanceObject, ContractConstructorObject } from "./types";
import type { ContractObject as Artifact } from "@truffle/contract-schema/spec";
export { InvalidAddressError, NoInternalInfoError, UnlinkedContractError, ContractNotFoundError, ContractNotDeployedError } from "./errors";
 ...
 */
export declare function forProject(settings: EncoderSettings): Promise<ProjectEncoder>;
/**
 * @protected
 * @category Constructors
 */
export declare function forProjectInternal(info: EncoderInfoInternal): Promise<ProjectEncoder>;
/**
 * **This function is asynchronous.**
 *
 ...
 * @category Constructors
 */
export declare function forArtifact(artifact: Artifact, settings?: EncoderSettings): Promise<ContractEncoder>;
/**
 * **This function is asynchronous.**
 *
 ...
 */
export declare function forContract(contract: ContractConstructorObject, settings?: EncoderSettings): Promise<ContractEncoder>;
/**
 * **This function is asynchronous.**
 *
 ...
 * @category Constructors
 */
export declare function forDeployedArtifact(artifact: Artifact, settings: EncoderSettings): Promise<ContractInstanceEncoder>;
/**
 * **This function is asynchronous.**
 *
 * Constructs a contract instance encoder for a deployed contract instance.
 ...
 * @category Truffle Contract-based Constructors
 */
export declare function forDeployedContract(contract: ContractConstructorObject, settings?: EncoderSettings): Promise<ContractInstanceEncoder>;
/**
 * **This function is asynchronous.**
 *
 ...
 */
export declare function forArtifactAt(artifact: Artifact, address: string, settings?: EncoderSettings): Promise<ContractInstanceEncoder>;
/**
 * **This function is asynchronous.**
 *
 ...
 * @category Truffle Contract-based Constructors
 */
export declare function forContractAt(contract: ContractConstructorObject, address: string, settings?: EncoderSettings): Promise<ContractInstanceEncoder>;
/**
 * **This function is asynchronous.**
 *
 * Constructs a contract instance encoder for a deployed contract instance.
 ...
 * @category Truffle Contract-based Constructors
 */
export declare function forContractInstance(contract: ContractInstanceObject, settings?: EncoderSettings): Promise<ContractInstanceEncoder>;
